(function($){
    $(document).ready(function(){
        $('.job-preference-link').click(function(){
            $('.personal-section').hide()
            $('.job-preference-section').show()
        })
        $('.personal-link').click(function(){
            $('.personal-section').show()
            $('.job-preference-section').hide()
        })
        ...
        $('.account-img').click(() => {
            $('#student-avatar-input').trigger('click');
        })
        $("#student-avatar-input").on('change', function() {
        ...
        function save_student_infor(){
            var data = {
                action: 'save_student_information'
            }
