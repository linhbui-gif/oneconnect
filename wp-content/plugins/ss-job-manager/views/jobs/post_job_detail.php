        ...
        <div class="col-inner text-left" style="background-color:rgb(255, 255, 255);">
          ...
          <div class="row row-inner-full" id="row-490066752">
            <div id="col-368971304" class="col small-12 large-12">
              <div class="col-inner">
                <p>
                  <input class="job-title" placeholder="Job Title" type="text">
                  <br>
                </p>
              </div>
            </div>
          ...
          <div class="row row-small row-inner-full" id="row-1144759287">
            <div id="col-1244241905" class="col medium-6 small-12 large-6">
              <div class="col-inner">
                <p>
                  <input class="job-address" placeholder="Address" type="text">
                  <br>
                </p>
              </div>
            </div>
                ...
                <?php $experience_levels = get_terms( array( 
                  ...
                  'hide_empty' => false
                    ...
                    <select class="experience-level" name="experience-level">
                      ...
                      <option value="<?php echo $experience_level->slug?>"><?php echo $experience_level->name?></option>
                      <?php endforeach;?>
                    </select>
                  <br>
                </p>
            ...
            <div id="col-1054173571" class="col small-12 large-12">
              <div class="col-inner">
                <p>
                  <input class="job-certification" placeholder="Certificate/Education" type="text">
                  <br>
                </p>
              </div>
            </div>
                ...
                <?php $salary_ranges =  get_terms( array( 
                  ...
                  'hide_empty' => false
                    ...
                    <select class="salary-range" name="salary-range">
                      ...
                      <option value="<?php echo $salary_range->slug?>"><?php echo $salary_range->name?></option>
                      <?php endforeach;?>
                    </select>
                  <br>
                </p>
          ...
          <div class="row row-small row-inner-full" id="row-1073299541">
            <div id="col-1416717497" class="col small-12 large-12">
              <div class="col-inner">
                <p>
                  <textarea class="job-des" placeholder="Describe job here..."></textarea>
                  <br>
                </p>
              </div>
              <style>
            ...
            <div id="col-1696358747" class="col small-12 large-12">
              <div class="col-inner">
                <p>
                  <textarea class="job-benefit" placeholder="Other benefit after sign contract"></textarea>
                  <br>
                </p>
              </div>
            </div>
