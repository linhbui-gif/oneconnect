<div id="col-1681719537" class="col medium-6 small-12 large-6">
    <div class="col-inner">
        <?php if($status == 'publish'):?>
            <div class="approved-icon">
                <span class="dashicons dashicons-yes-alt"></span> Approved
            </div>
        <?php endif;?>
        <?php if($status == 'pending'):?>
            <div class="waiting-icon">
                <span class="dashicons dashicons-info-outline"></span> Waiting
            </div>
        <?php endif;?>
        <?php if($status == 'reject'):?>
            <div class="declined-icon">
                <span class="dashicons dashicons-dismiss"></span> Declined
            </div>
        <?php endif;?>
        
        <a href="/edit-job/jobId/<?php echo $job->ID?>">
            <div class="dashicons dashicons-edit icon-topright-jobcard"></div>
        </a>
        
        <div id="text-117049486" class="text job-title-card">
            <p style="font-weight:bold; margin-bottom: 0;"><?php echo get_the_title($job->ID)?></p>
            <style>
            #text-117049486 {
                font-size: 1.1rem;
                color: rgb(0, 0, 0);
        ...
        <div id="gap-1853965731" class="gap-element clearfix" style="display:block; height:auto;">
            <style>
            #gap-1853965731 {
                padding-top: 10px;
            }
        ...
        <div class="icon-box featured-box icon-box-left text-left">
            ...
            <div class="icon-box-text last-reset">
                ...
                $type = '';
                if(empty($type)){
                $type_terms = get_the_terms($job->ID, 'job_listing_type');
        ...
        <div class="icon-box featured-box icon-box-left text-left">
            ...
            <div class="icon-box-text last-reset">
                <?php
                $shift = '';
                $shift_terms = get_the_terms($job->ID, 'shift');
        ...
        <div id="gap-293586119" class="gap-element clearfix" style="display:block; height:auto;">
            <style>
            #gap-293586119 {
                padding-top: 5px;
            }
        ...
        <div class="salary-btn-job-card">
            <div id="text-3076999926" class="text salary-job-card">
                <p style="margin-bottom:0">
                <?php
                    $salary = get_post_meta($job->ID,'_job_salary', true);
                    if(empty($salary)){
                    $salary_terms = get_the_terms($job->ID, 'salary_range');
            ...
            <a class="button success is-small button-job-card" style="border-radius:99px;" href="/interview-dashboard?job=<?php echo $job->ID?>">
