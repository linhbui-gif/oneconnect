        ...
        <div class="col-inner text-left" style="background-color:rgb(255, 255, 255);">
          ...
          <div class="row row-small row-inner-full" id="row-1418627182">
            <div id="col-204352665" class="col medium-6 small-12 large-12">
              <div class="col-inner">
                <p>
                  <input class="candidate-name" placeholder="Candidate Full Name*" type="text">
                  <br>
                </p>
              </div>
            </div> 
            <div id="col-1770729305" class="col medium-6 small-12 large-6">
              <div class="col-inner">
                <p>
                  <input class="candidate-dob" placeholder="Date of Birth* " type="date">
                  <br>
                </p>
              </div>
              <style>
            ...
            <div id="col-1078479094" class="col medium-6 small-12 large-6">
              <div class="col-inner">
                <p>
                  <input class="candidate-email" placeholder="E-mail"  type="email" name="email-647">
                  <br>
                </p>
              </div>
            </div>
            <div id="col-556386308" class="col medium-6 small-12 large-6">
              <div class="col-inner">
                <p>
                  <input class="candidate-phone" placeholder="Phone* " type="tel" name="sodienthoai">
                  <br>
                </p>
              </div>
            </div>
            ...
            <div id="col-104888616" class="col small-12 large-6">
              <div class="col-inner">
                <p>
                  <input class="candidate-address" placeholder="Address" type="text">
                  <br>
                </p>
              </div>
            </div>
          ...
          <div class="row row-small row-inner-full candidate-others-row" id="row-6713576">  
                ...
                <?php $skills = $terms = get_terms( array( 
                  ...
                  'hide_empty' => false
                    ...
                    <select class="multi-select candidate-skills" name="skills[]" multiple="multiple">
                      ...
                      <option value="<?php echo $skill->slug?>"><?php echo $skill->name?></option>
                      <?php endforeach;?>
                    </select>
              </div>
            </div>
            ...
            <div id="col-41512661" class="col small-12 large-12">
              <div class="col-inner">
                ...
                <p>
                  <textarea class="candidate-about" placeholder="Describe yourself here..."></textarea>
                  <br>
                </p>
              </div>
              <style>
              ...
              <div class="col-inner" style="background-color:rgba(255, 255, 255, 0);">
                <div class="img has-hover user-avatar-detail x md-x lg-x y md-y lg-y" id="image_1887381361">
                  <div class="img-inner image-cover dark" style="padding-top:100%;">
                    <img class="account-img" width="315" height="289" src="/wp-content/uploads/empty_avatar.jpg" class="attachment-original size-original" alt="" decoding="async" loading="lazy" sizes="(max-width: 315px) 100vw, 315px">
                ...
                <?php $job_functions = $terms = get_terms( array( 
                  ...
                  'hide_empty' => false
                    ...
                    <select class="multi-select candidate-job-function" name="job_functions[]" multiple="multiple">
                      ...
                      <option value="<?php echo $job_function->slug?>"><?php echo $job_function->name?></option>
                      <?php endforeach;?>
                    </select>
              </div>
            </div>
                ...
                <?php $start_days = get_terms( array( 
                  ...
                  'hide_empty' => false
                      ...
                      <?php foreach($start_days as $start_day):?>
                        <input type="radio" id="<?php echo $start_day->slug?>" name="start_day" class="start_day" value="<?php echo $start_day->slug?>">
                ...
                <?php $workplaces = get_terms( array( 
                  ...
                  'hide_empty' => false
                    ...
                    <select class="multi-select candidate-workplace" name="workplaces[]" multiple="multiple">
                      ...
                      <option value="<?php echo $workplace->slug?>"><?php echo $workplace->name?></option>
                      <?php endforeach;?>
                    </select>
              </div>
            </div>
                ...
                <?php $working_locations = get_terms( array( 
                  ...
                  'hide_empty' => false
                    ...
                    <select class="multi-select candidate-working-location" name="working_locations[]" multiple="multiple">
                      ...
                      <option value="<?php echo $working_location->slug?>"><?php echo $working_location->name?></option>
                      <?php endforeach;?>
                    </select>
              </div>
            </div>
                ...
                <?php $shifts = get_terms( array( 
                  ...
                  'hide_empty' => false
                    ...
                    <select class="multi-select candidate-shift" name="shifts[]" multiple="multiple">
                      ...
                      <option value="<?php echo $shift->slug?>"><?php echo $shift->name?></option>
                      <?php endforeach;?>
                    </select>
              </div>
                ...
                <?php $job_listing_types = get_terms( array( 
                  ...
                  'hide_empty' => false
                    ...
                    <select class="multi-select candidate-job-type" name="job_types[]" multiple="multiple">
                      ...
                      <option value="<?php echo $job_listing_type->slug?>"><?php echo $job_listing_type->name?></option>
                      <?php endforeach;?>
                    </select>
              </div>
