      ...
      <div id="col-1315376639" class="col personal-info medium-12 small-12 large-8">
        <div class="col-inner text-left" style="background-color:rgb(255, 255, 255);">
          <div id="text-3113725459" class="text">
            <h2 style="margin-bottom: 0;">Company information</h2>
            <style>
              #text-3113725459 {
                font-size: 1rem;
                color: rgb(0, 0, 0);
          ...
          <div class="row row-small row-inner-full" id="row-1854055404">
            <div id="col-102756810" class="col small-12 large-12">
              <div class="col-inner">
                <p>
                  <input value="<?php echo get_the_title($company_id)?>" class="company-name" placeholder="Company name*" type="text">
                  <br>
                </p>
              </div>
            </div>
            <div id="col-300608156" class="col small-12 large-12">
              <div class="col-inner">
                <p>
                  <input value="<?php echo get_post_meta($company_id, '_company_address', true)?>" class="company-address" placeholder="Address (base on license)" type="text">
                  <br>
                </p>
              </div>
            </div>
            <div id="col-1636915418" class="col medium-6 small-12 large-6">
              <div class="col-inner">
                <p>
                  <input vlue="<?php echo get_post_meta($company_id, '_company_liscense', true)?>" class="company-liscense" placeholder="Liscense numbers" value="" type="text">
                  <br>
                </p>
              </div>
            </div>
            <div id="col-1870595931" class="col medium-6 small-12 large-6">
              <div class="col-inner">
                <p>
                  <input value="<?php echo get_post_meta($company_id, '_company_industry', true)?>" class="company-industry" placeholder="Industry" value="" type="text">
                  <br>
                </p>
              </div>
            </div>
            <div id="col-481117216" class="col small-12 large-12">
              <div class="col-inner">
                <p>
                  <input value="<?php echo get_post_meta($company_id, '_company_website', true)?>" class="company-website" placeholder="Website" type="text">
                  <br>
                </p>
              </div>
            </div>
          ...
          <div class="row row-small row-inner-full" id="row-216398620">
            <div id="col-1722696256" class="col small-12 large-12">
              <div class="col-inner">
                <p>
                  <input value="<?php echo get_post_meta($company_id, '_company_street_building', true)?>" class="company-street" placeholder="Street/Building" type="text">
                  <br>
                </p>
              </div>
            </div>
            <div id="col-986741511" class="col small-12 large-12">
              <div class="col-inner">
                <p>
                  <input value="<?php echo get_post_meta($company_id, '_company_building_number', true)?>" class="company-bulding-number" placeholder="Address/Building number" type="text">
                  <br>
                </p>
              </div>
            </div>
            <div id="col-208919955" class="col small-12 large-12">
              <div class="col-inner">
                <p>
                  <input value="<?php echo get_post_meta($company_id, '_company_additional_information', true)?>" class="company-additional-address" placeholder="Additional address information (optional)" type="text">
                  <br>
                </p>
              </div>
            </div>
          ...
          <div class="row row-small row-inner-full" id="row-1308214276">
            <div id="col-282643245" class="col medium-6 small-12 large-6">
              <div class="col-inner">
                <p>
                  <input value="<?php echo get_post_meta($company_id, '_company_email', true)?>" class="_company_email" placeholder="E-mail" value="" type="email" name="email-647">
                  <br>
                </p>
              </div>
            </div>
            <div id="col-894293767" class="col medium-6 small-12 large-6">
              <div class="col-inner">
                <p>
                  <input value="<?php echo get_post_meta($company_id, '_company_phone', true)?>" class="company-phone" placeholder="Phone* " value="" type="tel" name="sodienthoai">
                  <br>
                </p>
              </div>
            </div>
            <div id="col-1781242488" class="col small-12 large-12">
              <div class="col-inner">
                <p>
                  <input value="<?php echo get_post_meta($company_id, '_company_title', true)?>" class="company-title" placeholder="Title" type="text">
                  <br>
                </p>
              </div>
            </div>
          ...
          <div class="row row-inner-full" id="row-1313151676">
            <div id="col-2005035527" class="col small-12 large-12">
              <div class="col-inner text-right">
                <a class="submit-company-btn button primary lowercase" style="border-radius:10px;padding:3px 20px 3px 20px;">
                  <span>Submit</span>
                </a>
              </div>
            </div>
