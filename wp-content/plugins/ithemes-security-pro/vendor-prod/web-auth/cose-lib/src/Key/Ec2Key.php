...
namespace iThemesSecurity\Strauss\Cose\Key;

use function array_key_exists;
use iThemesSecurity\Strauss\Assert\Assertion;
use iThemesSecurity\Strauss\FG\ASN1\ExplicitlyTaggedObject;
use iThemesSecurity\Strauss\FG\ASN1\Universal\BitString;
use iThemesSecurity\Strauss\FG\ASN1\Universal\Integer;
