...
use iThemesSecurity\Strauss\FG\ASN1\Universal\OctetString;
...
use iThemesSecurity\Strauss\FG\X509\SAN\SubjectAlternativeNames;
...
class CertificateExtensions extends Set implements Parsable
{
    ...
    public static function fromBinary(&$binaryData, &$offsetIndex = 0)
    {
        ...
        foreach ($extensions as $extension) {
            ...
            /** @var \iThemesSecurity\Strauss\FG\ASN1\ASNObject $objectIdentifier */
