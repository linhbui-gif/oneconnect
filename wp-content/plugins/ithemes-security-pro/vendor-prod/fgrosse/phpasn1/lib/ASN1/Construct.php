...
use ArrayIterator;
use Countable;
use iThemesSecurity\Strauss\FG\ASN1\Exception\ParserException;
use Iterator;

abstract class Construct extends ASNObject implements Countable, ArrayAccess, Iterator, Parsable
{
    /** @var \iThemesSecurity\Strauss\FG\ASN1\ASNObject[] */
    protected $children;
    private $iteratorPosition;

    /**
     * @param \iThemesSecurity\Strauss\FG\ASN1\ASNObject[] $children the variadic type hint is commented due to https://github.com/facebook/hhvm/issues/4858
     */
    ...
    /**
     * @return \iThemesSecurity\Strauss\FG\ASN1\ASNObject[]
     */
