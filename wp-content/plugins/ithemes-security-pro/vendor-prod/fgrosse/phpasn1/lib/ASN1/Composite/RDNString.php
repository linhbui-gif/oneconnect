...
use iThemesSecurity\Strauss\FG\ASN1\Universal\PrintableString;
use iThemesSecurity\Strauss\FG\ASN1\Universal\IA5String;
use iThemesSecurity\Strauss\FG\ASN1\Universal\UTF8String;

class RDNString extends RelativeDistinguishedName
{
    /**
     * @param string|\iThemesSecurity\Strauss\FG\ASN1\Universal\ObjectIdentifier $objectIdentifierString
     * @param string|\iThemesSecurity\Strauss\FG\ASN1\ASNObject $value
     */
